...
TOPIC_KEYWORDS = {
    "math": ["calculus", "derivative", "integral", "algebra", "matrix", "probability", "statistics"],
    "cs": ["algorithm", "recursion", "complexity", "binary", "graph", "sorting", "dynamic programming"],
    "physics": ["force", "energy", "quantum", "velocity", "thermodynamics", "entropy"],
    "ml": ["gradient", "neural", "loss function", "backprop", "overfitting", "embedding"],
}
